    ...
    <>
      ...
      <div className="p-4">
        ...
        <PostComponent
          user={{ name: "Jenna", link: "/@jenna", username: "@jenna", image: "/images/user.png" }}
          data={{
            post: "Months on ye at by esteem desire warmth former. Sure that that way gave any fond now. His boy middleton sir nor engrossed affection excellent. Dissimilar compliment cultivated preference eat sufficient may. Well next door soon we mr he four.",
            images: [
              "https://images.pexels.com/photos/17371711/pexels-photo-17371711/free-photo-of-pretty-girl-with-a-yellow-flower-between-her-fingers-as-a-ring.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
            ],
            time: "3h"
